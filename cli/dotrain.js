...
const getOptions = async args => new Command("dotrain")
    ...
    .requiredOption("-i, --input <path>", "Path to input file, either a .rain file for compiling or .json for decompiling (always required)")
    .requiredOption("-o, --output <path>", "Path to output file, will output .json for compile mode and .rain for decompile mode (always required)")
